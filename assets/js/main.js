...
// Initially, the body has the dark theme
document.body.classList.add(darkTheme);

// Show dark theme icon
...
themeButton.addEventListener("click", () => {
  ...
  if (document.body.classList.contains(darkTheme)) {
    ...
    themeButton.classList.remove(iconTheme); // Remove moon icon
  } else {
    document.body.classList.add(darkTheme);
    themeButton.classList.add(iconTheme); // Add moon icon
  }
});
